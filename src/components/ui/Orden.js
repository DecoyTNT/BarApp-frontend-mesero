        ...
        <div className="sm:w-1/3 lg:w-1/3 px-2 mb-4">
            <div className="p-3 shadow-md bg-white">
                ...
                <div className="mb-4">
                    ...
                    {!orden.proceso && (
                        <>
                            <p className="text-gray text-2xl font-bold">La orden aún no esta en proceso</p>
                        </>
                    )}
                </div>
                ...
                {!orden.completada && orden.proceso && (
                    <>
                        <p className="text-gray text-2xl font-bold">La orden esta en proceso</p>
                    </>
                )}
                {orden.completada && (
                    <p className="text-gray text-2xl font-bold">La orden ya esta lista</p>
                )}
            </div>
        </div>
    );
